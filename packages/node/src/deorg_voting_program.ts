...
export type DeorgVotingProgram = {
  ...
  instructions: [
    ...
    },
    {
      ...
      discriminator: [203, 147, 161, 208, 2, 107, 168, 0];
      accounts: [
        {
          name: 'reviewer';
          writable: true;
    ...
    },
    {
      ...
      discriminator: [92, 201, 184, 148, 233, 144, 85, 109];
      accounts: [
        {
          name: 'executor';
          writable: true;
    ...
    },
    {
      ...
      discriminator: [4, 25, 79, 4, 119, 210, 129, 78];
      accounts: [
        {
          name: 'authority';
          writable: true;
    ...
    },
    {
      ...
      discriminator: [115, 219, 17, 2, 166, 242, 26, 246];
      accounts: [
        {
          name: 'proposer';
          writable: true;
    ...
    },
    {
      ...
      discriminator: [62, 64, 99, 52, 232, 221, 154, 169];
      accounts: [
        {
          name: 'proposer';
          writable: true;
    ...
    {
      name: 'proposeProject';
      discriminator: [151, 73, 101, 5, 57, 51, 143, 49];
      accounts: [
        {
          name: 'proposer';
          writable: true;
    ...
    },
    {
      ...
      discriminator: [27, 21, 241, 167, 180, 87, 158, 76];
      accounts: [
        {
          name: 'authority';
          writable: true;
    ...
    },
    {
      ...
      discriminator: [176, 163, 252, 152, 116, 181, 215, 93];
      accounts: [
        {
          name: 'organization';
          writable: true;
    ...
    },
    {
      ...
      discriminator: [103, 215, 229, 85, 252, 164, 113, 142];
      accounts: [
        {
          name: 'voter';
          writable: true;
    ...
    },
    {
      ...
      discriminator: [25, 248, 122, 152, 76, 18, 48, 15];
      accounts: [
        {
          name: 'voter';
          writable: true;
    ...
    },
    {
      ...
      discriminator: [106, 87, 130, 253, 215, 99, 195, 123];
      accounts: [
        {
          name: 'voter';
          writable: true;
  ...
  accounts: [
    {
      name: 'contributor';
      discriminator: [222, 222, 255, 212, 133, 49, 27, 93];
    },
    {
      name: 'contributorProposal';
      discriminator: [105, 174, 63, 121, 130, 211, 212, 24];
    },
    {
      name: 'organization';
    ...
    },
    {
      ...
      discriminator: [238, 138, 195, 133, 237, 154, 92, 125];
    },
    {
      name: 'task';
    ...
    },
    {
      ...
      discriminator: [193, 105, 245, 232, 239, 167, 104, 138];
    },
    {
  ...
  events: [
    {
      ...
      discriminator: [163, 103, 5, 85, 73, 132, 231, 179];
    },
    {
    ...
    },
    {
      ...
      discriminator: [59, 11, 67, 179, 7, 70, 160, 186];
    },
    {
      name: 'projectReadyEvent';
      discriminator: [31, 76, 197, 182, 37, 117, 100, 188];
    },
    {
    ...
    },
    {
      ...
      discriminator: [95, 254, 137, 96, 220, 33, 97, 33];
    },
    {
      name: 'taskVaultCreatedEvent';
      discriminator: [252, 121, 95, 161, 68, 1, 254, 201];
    },
    {
      name: 'taskVaultWithdrawalEnabledEvent';
      discriminator: [139, 109, 86, 243, 199, 98, 99, 149];
    },
    {
      name: 'taskVoteEvent';
      discriminator: [82, 233, 126, 106, 31, 124, 96, 25];
    },
    {
      name: 'treasuryDepositEvent';
      discriminator: [25, 50, 133, 111, 59, 244, 109, 52];
    },
    {
      name: 'treasuryTokenRegisteredEvent';
      discriminator: [72, 20, 100, 76, 242, 14, 154, 106];
    },
    {
      name: 'treasuryTransferExecutedEvent';
      discriminator: [139, 118, 43, 166, 152, 251, 203, 158];
    },
    {
      name: 'treasuryTransferProposalEvent';
      discriminator: [71, 27, 106, 116, 212, 244, 190, 249];
    },
    {
      name: 'treasuryTransferVoteEvent';
      discriminator: [98, 232, 196, 248, 84, 178, 49, 15];
    },
    {
      name: 'voteEvent';
